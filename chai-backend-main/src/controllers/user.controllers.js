...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  const channel = await User.aggregate([
    ...
    },
    {
      $lookup: {
        from: "subscriptions",
        localField: "_id", // Match user._id with channel
    ...
    },
    {
      $lookup: {
        from: "subscriptions",
        localField: "_id", // Match user._id with subscribers
    ...
    },
    {
      $lookup: {
        from: "videos",
        localField: "_id", // Match user._id with video owner
        foreignField: "owner",
        as: "videos", // Store the user's videos in this array
      },
    },
    {
      ...
      $project: {
        ...
        coverImage: 1,
        email: 1,
        videos: 1, // Include the videos in the response
      },
    },
  ]);
